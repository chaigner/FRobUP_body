...
if ndim == 3
    [xx,yy,zz]=ndgrid(-fov(1)/2:fov(1)/dimxyz(1):fov(1)/2-fov(1)/dimxyz(1), ...
        ...
        -fov(3)/2:fov(3)/(dimxyz(3)/maps.numberofmaps):fov(3)/2-fov(3)/(dimxyz(3)/maps.numberofmaps));
elseif ndim == 2
...
zz=repmat(zz,[1 1 maps.numberofmaps]);
xx=repmat(xx,[1 1 maps.numberofmaps]);
yy=repmat(yy,[1 1 maps.numberofmaps]);
